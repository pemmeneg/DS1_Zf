...
\begin{document}
    ...
    \begin{multicols*}{3}
        ...
        \input{../content/02_protocols.tex}
        \input{../content/03_virtualization.tex}
        \input{../content/04_loadbalancing.tex}
        \input{../content/05_authentication.tex}
        \input{../content/06_application_protocols.tex}
        \input{../content/08_git.tex}
        \input{../content/09_bitcoin_blockchain.tex}
        \input{../content/10_deployment.tex}
